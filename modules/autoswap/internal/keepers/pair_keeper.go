...
type IPairKeeper interface {
	...
	DeleteOrder(ctx sdk.Context, order types.MsgAutoSwapCancelOrder) sdk.Error
...
func (pk *PairKeeper) DeleteOrder(ctx sdk.Context, msg types.MsgAutoSwapCancelOrder) sdk.Error {
